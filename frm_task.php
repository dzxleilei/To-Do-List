        ...
        <form id="resetform">
          ...
          <div class="inputForm2">
            ...
            <div>
              <h3>Reminder</h3>
              <div class="customSelect">
                <input class="textField" type="number" name="reminder_number" id="reminder_number"
          ...
          <div class="inputForm">
            ...
            <div class="customSelect">
              <select class="js-example-basic-multiple" name="collaborators[]" multiple="multiple" id="collaborators">
